...
object ModuleAutoPot : Module("AutoPot", Category.COMBAT) {
    ...
    private fun isPotion(stack: ItemStack): Boolean {
        ...
        val potionEffects = PotionUtil.getPotionEffects(stack)
        val hasSpeedEffect = potionEffects.any {
            it.effectType == StatusEffects.SPEED || it.effectType == StatusEffects.HASTE
